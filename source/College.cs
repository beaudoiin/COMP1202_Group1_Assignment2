        ...
        public void LoadData()
        {
            ...
            if (File.Exists("students.txt"))
            {
                foreach (var line in File.ReadAllLines("students.txt"))
                {
                    ...
                    Student s = new Student(parts[1], parts[2]);
                    students.Add(s);
                }
            }
            ...
            if (File.Exists("courses.txt"))
            {
                ...
                {
                    var parts = line.Split(',');
                    Course c = new Course(parts[1], int.Parse(parts[2]), "No description");
                    courses.Add(c);
                }
            }
            ...
            if (File.Exists("registrations.txt"))
            {
                ...
                {
                    var parts = line.Split(',');
                    int sIndex = students.FindIndex(s => s.StudentId == int.Parse(parts[0]));
